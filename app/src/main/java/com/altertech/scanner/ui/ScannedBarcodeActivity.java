        ...
        this.surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    ...
                    ToastHelper.toast(ScannedBarcodeActivity.this, R.string.app_qr_io_error);
                }
            }
                ...
                if (detectedItems != null && detectedItems.size() >= 1) {
                    ...
                    if (barcode != null) {
                        ...
                        try {
                            ...
                            ScannedBarcodeActivity.this.showStatus(R.string.app_settings_exception_bad_input_code);
                        }
                    }
                }
            }
